...
CYCLE: '<N> sessions last 7d | next up: <session name>' plus one short clause only if a session type is 10+ days stale, and, when rest.meets_target is false, a clause naming the streak (e.g. 'no rest day in 9 days, take one before the next session').
